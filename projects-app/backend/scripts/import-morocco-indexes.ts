/**
 * ═══════════════════════════════════════════════════════════════════════════════════
 * 📊 IMPORT MOROCCO OFFICIAL INDEXES - Barème d'Indexation
 * ═══════════════════════════════════════════════════════════════════════════════════
 * 
 * ⚠️ مصدر البيانات: وزارة التجهيز والماء - المغرب
 * 
 * المؤشرات المدعومة:
 * ─────────────────────────────────────────────────────────────────────────────────
 * 
 ...
 * 
 * AUTRES:
 *   Mc1  - Matériaux de construction (indice global)
 *   Mc2  - Matériaux de construction (autre indice)
 *   Exp  - Explosifs
 * 
 * ─────────────────────────────────────────────────────────────────────────────────
 ...
 * 
 * ASSAINISSEMENT:
 *   ASS  - Assainissement (global)
 * 
 * ÉLECTRIFICATION:
 *   EL   - Électrification rurale
 * 
 * ─────────────────────────────────────────────────────────────────────────────────
 * 📋 LISTE N°3 - SALAIRES & CHARGES SOCIALES
 * ─────────────────────────────────────────────────────────────────────────────────
 * 
 * SALAIRES (Base 100 = Janvier 1982):
...
const pool = new Pool({
  ...
  database: process.env.POSTGRES_DB || 'btpdb_staging',
...
/**
 * Liste complète des index officiels avec leur description
 */
export const OFFICIAL_INDEX_CATALOG = {
  // ═══════════════════════════════════════════════════════════════════════════
  // LISTE N°1 - INDEX SIMPLES
  // ═══════════════════════════════════════════════════════════════════════════
  
  // Métaux ferreux
  At: { name: "Acier pour béton armé", category: "Métaux ferreux", base: 100, baseYear: 1982 },
  Fe: { name: "Fers et aciers menuiserie", category: "Métaux ferreux", base: 100, baseYear: 1982 },
  Tf: { name: "Tubes, fils et câbles acier", category: "Métaux ferreux", base: 100, baseYear: 1982 },
  Tg: { name: "Tôles galvanisées", category: "Métaux ferreux", base: 100, baseYear: 1982 },
  Tn: { name: "Tôles noires", category: "Métaux ferreux", base: 100, baseYear: 1982 },
  Fb: { name: "Fonte et pièces de fonte", category: "Métaux ferreux", base: 100, baseYear: 1982 },
  
  // Matériaux de construction
  Cv: { name: "Céramique et carrelage", category: "Matériaux", base: 100, baseYear: 1982 },
  Cs: { name: "Ciment", category: "Matériaux", base: 100, baseYear: 1982 },
  Br: { name: "Briques et hourdis", category: "Matériaux", base: 100, baseYear: 1982 },
  Gc: { name: "Granulats et carrière", category: "Matériaux", base: 100, baseYear: 1982 },
  Gp: { name: "Gypse et plâtre", category: "Matériaux", base: 100, baseYear: 1982 },
  Bo: { name: "Bois", category: "Matériaux", base: 100, baseYear: 1982 },
  Ag: { name: "Agrégats", category: "Matériaux", base: 100, baseYear: 1982 },
  Mc1: { name: "Matériaux construction I", category: "Matériaux", base: 100, baseYear: 1982 },
  Mc2: { name: "Matériaux construction II", category: "Matériaux", base: 100, baseYear: 1982 },
  
  // Énergie & Carburants
  G: { name: "Gasoil", category: "Énergie", base: 100, baseYear: 1982 },
  Fu: { name: "Fuel-oil", category: "Énergie", base: 100, baseYear: 1982 },
  Esp: { name: "Essence", category: "Énergie", base: 100, baseYear: 1982 },
  El: { name: "Électricité", category: "Énergie", base: 100, baseYear: 1982 },
  Lub: { name: "Lubrifiants", category: "Énergie", base: 100, baseYear: 1982 },
  
  // Bitumes & Liants
  Bi: { name: "Bitume", category: "Bitumes", base: 100, baseYear: 1982 },
  Em: { name: "Émulsion de bitume", category: "Bitumes", base: 100, baseYear: 1982 },
  
  // Peintures
  Pe: { name: "Peintures", category: "Peintures", base: 100, baseYear: 1982 },
  
  // Métaux non ferreux
  Cu: { name: "Cuivre et alliages", category: "Métaux non ferreux", base: 100, baseYear: 1982 },
  Al: { name: "Aluminium et alliages", category: "Métaux non ferreux", base: 100, baseYear: 1982 },
  Zn: { name: "Zinc", category: "Métaux non ferreux", base: 100, baseYear: 1982 },
  Pb: { name: "Plomb", category: "Métaux non ferreux", base: 100, baseYear: 1982 },
  
  // Plastiques
  Pl: { name: "Plastiques", category: "Plastiques", base: 100, baseYear: 1982 },
  Tp: { name: "Tubes PVC", category: "Plastiques", base: 100, baseYear: 1982 },
  
  // Explosifs
  Exp: { name: "Explosifs", category: "Autres", base: 100, baseYear: 1982 },
  ...
  // Travaux Routiers
  TR: { name: "Travaux routiers (global)", category: "Index globaux", base: 100, baseYear: 1982 },
  TR1: { name: "Terrassements", category: "Index globaux", base: 100, baseYear: 1982 },
  TR2: { name: "Chaussées traitées", category: "Index globaux", base: 100, baseYear: 1982 },
  TR3: { name: "Couches roulement enrobés", category: "Index globaux", base: 100, baseYear: 1982 },
  TR4: { name: "Couches superficielles", category: "Index globaux", base: 100, baseYear: 1982 },
  TR5: { name: "Signalisation horizontale", category: "Index globaux", base: 100, baseYear: 1982 },
  
  // Ouvrages d'Art
  OA: { name: "Ouvrages d'art (global)", category: "Index globaux", base: 100, baseYear: 1982 },
  OA1: { name: "Gros œuvre béton armé", category: "Index globaux", base: 100, baseYear: 1982 },
  OA2: { name: "Construction métallique", category: "Index globaux", base: 100, baseYear: 1982 },
  
  // Bâtiment
  BAT: { name: "Bâtiment (global)", category: "Index globaux", base: 100, baseYear: 1982 },
  BAT1: { name: "Gros œuvre", category: "Index globaux", base: 100, baseYear: 1982 },
  BAT2: { name: "Second œuvre", category: "Index globaux", base: 100, baseYear: 1982 },
  BAT3: { name: "Équipements techniques", category: "Index globaux", base: 100, baseYear: 1982 },
  
  // Sondages & Forages
  SF: { name: "Sondages/forages (global)", category: "Index globaux", base: 100, baseYear: 1982 },
  SF1: { name: "Forages d'eau", category: "Index globaux", base: 100, baseYear: 1982 },
  SF2: { name: "Sondages géotechniques", category: "Index globaux", base: 100, baseYear: 1982 },
  
  // Eau Potable
  AEP: { name: "Eau potable (global)", category: "Index globaux", base: 100, baseYear: 1982 },
  CEP: { name: "Conduites eau potable", category: "Index globaux", base: 100, baseYear: 1982 },
  REP: { name: "Réservoirs eau potable", category: "Index globaux", base: 100, baseYear: 1982 },
  
  // Assainissement
  ASS: { name: "Assainissement", category: "Index globaux", base: 100, baseYear: 1982 },
  ...
  // Salaires
  S: { name: "Salaire horaire moyen", category: "Salaires", base: 100, baseYear: 1982 },
  S1: { name: "Manœuvre ordinaire", category: "Salaires", base: 100, baseYear: 1982 },
  S2: { name: "Manœuvre spécialisé", category: "Salaires", base: 100, baseYear: 1982 },
  S3: { name: "Ouvrier qualifié", category: "Salaires", base: 100, baseYear: 1982 },
  S4: { name: "Ouvrier hautement qualifié", category: "Salaires", base: 100, baseYear: 1982 },
  S5: { name: "Chef d'équipe", category: "Salaires", base: 100, baseYear: 1982 },
  
  // Charges Sociales
  ChTP: { name: "Charges sociales TP", category: "Charges sociales", base: 100, baseYear: 1982 },
  ChB: { name: "Charges sociales Bâtiment", category: "Charges sociales", base: 100, baseYear: 1982 },
  ChG: { name: "Charges sociales générales", category: "Charges sociales", base: 100, baseYear: 1982 },
};

/**
 * Données officielles des Index - Janvier 2024 (exemple)
 * Source: Barème d'indexation - Ministère de l'Équipement et de l'Eau
 * 
 * ⚠️ Ces données doivent être vérifiées et complétées depuis les sources officielles
 */
const OFFICIAL_DATA_2024: IndexRecord[] = [
  // ═══════════════════════════════════════════════════════════════════════════
  // ANNÉE 2024 - Données officielles
  // Source: Circulaire du Ministère de l'Équipement
  // ═══════════════════════════════════════════════════════════════════════════
  {
    monthDate: '2024-01-01',
    source: 'Barème officiel - Janvier 2024',
    notes: 'Index définitif (*)',
    indexValues: {
      // Métaux ferreux
  ...
  },
  {
    ...
    source: 'Barème officiel - Février 2024',
    notes: 'Index définitif (*)',
    indexValues: {
  ...
  },
  {
    ...
    source: 'Barème officiel - Mars 2024',
    notes: 'Index définitif (*)',
    indexValues: {
  ...
  },
  {
    ...
    source: 'Barème officiel - Avril 2024',
    notes: 'Index définitif (*)',
    indexValues: {
  ...
  },
  {
    ...
    source: 'Barème officiel - Mai 2024',
    notes: 'Index définitif (*)',
    indexValues: {
  ...
  },
  {
    ...
    source: 'Barème officiel - Juin 2024',
    notes: 'Index définitif (*)',
    indexValues: {
  ...
  },
  {
    ...
    source: 'Barème officiel - Juillet 2024',
    notes: 'Index définitif (*)',
    indexValues: {
  ...
  },
  {
    ...
    source: 'Barème officiel - Août 2024',
    notes: 'Index définitif (*)',
    indexValues: {
  ...
  },
  {
    ...
    source: 'Barème officiel - Septembre 2024',
    notes: 'Index définitif (*)',
    indexValues: {
  ...
  },
  {
    ...
    source: 'Barème officiel - Octobre 2024',
    notes: 'Index provisoire (**)',
    indexValues: {
  ...
  {
    monthDate: '2024-11-01',
    source: 'Barème officiel - Novembre 2024',
    notes: 'Index provisoire (**)',
    indexValues: {
  ...
  },
  {
    ...
    source: 'Barème officiel - Décembre 2024',
    notes: 'Index provisoire (**)',
    indexValues: {
...
/**
 * Import indexes to database
 */
async function importIndexes(data: IndexRecord[]): Promise<void> {
  console.log('═'.repeat(70));
  console.log('📊 IMPORTING MOROCCO OFFICIAL INDEXES');
  console.log('═'.repeat(70));
  ...
  for (const record of data) {
    try {
      ...
      if (existing.rows.length > 0) {
        // Update existing record (merge indexes)
        await pool.query(`
          UPDATE revision_indexes 
          SET index_values = index_values || $1::jsonb,
              source = $2,
              notes = $3,
              updated_at = CURRENT_TIMESTAMP
          WHERE month_date = $4
        `, [JSON.stringify(record.indexValues), record.source, record.notes || null, record.monthDate]);
        
        updated++;
        console.log(`✅ Updated: ${record.monthDate} (${Object.keys(record.indexValues).length} indexes)`);
      } else {
        // Insert new record
        await pool.query(`
          INSERT INTO revision_indexes (month_date, index_values, source, notes)
          VALUES ($1, $2, $3, $4)
        `, [record.monthDate, JSON.stringify(record.indexValues), record.source, record.notes || null]);
        
        imported++;
        console.log(`✅ Imported: ${record.monthDate} (${Object.keys(record.indexValues).length} indexes)`);
      }
    } catch (error) {
      errors++;
      console.error(`❌ Error for ${record.monthDate}:`, error);
    }
  }
  ...
  console.log(`  📊 Total indexes per month: ${Object.keys(data[0]?.indexValues || {}).length}`);
  console.log('═'.repeat(70));
}

/**
 * Generate report of available indexes
 */
async function generateReport(): Promise<void> {
  console.log('');
  console.log('═'.repeat(70));
  console.log('📋 INDEX AVAILABILITY REPORT');
  console.log('═'.repeat(70));
  
  // Get all records
  const result = await pool.query(`
    SELECT month_date, index_values, source, notes
    FROM revision_indexes
    ORDER BY month_date ASC
  `);
  
  if (result.rows.length === 0) {
    console.log('⚠️ No indexes in database');
    return;
  }
  ...
  result.rows.forEach(row => {
    Object.keys(row.index_values).forEach(name => allIndexNames.add(name));
  });
  
  const firstMonth = result.rows[0].month_date;
  const lastMonth = result.rows[result.rows.length - 1].month_date;
  
  console.log(`  📅 First month: ${firstMonth}`);
  console.log(`  📅 Last month: ${lastMonth}`);
  console.log(`  📊 Total months: ${result.rows.length}`);
  console.log(`  📋 Total unique indexes: ${allIndexNames.size}`);
  console.log('');
  
  // Group by category
  const categories: Record<string, string[]> = {};
  for (const name of Array.from(allIndexNames).sort()) {
    const info = OFFICIAL_INDEX_CATALOG[name as keyof typeof OFFICIAL_INDEX_CATALOG];
    const category = info?.category || 'Autres';
    if (!categories[category]) categories[category] = [];
    categories[category].push(name);
  }
  
  console.log('📋 INDEXES BY CATEGORY:');
  console.log('─'.repeat(70));
  for (const [category, indexes] of Object.entries(categories).sort()) {
    console.log(`\n  ${category}:`);
    indexes.forEach(idx => {
      const info = OFFICIAL_INDEX_CATALOG[idx as keyof typeof OFFICIAL_INDEX_CATALOG];
      console.log(`    • ${idx.padEnd(6)} - ${info?.name || 'Unknown'}`);
    });
  }
...
async function main() {
  console.log('');
  console.log('╔══════════════════════════════════════════════════════════════════════╗');
  console.log('║   📊 MOROCCO OFFICIAL INDEX IMPORT TOOL                              ║');
  console.log('║   Barème d\'Indexation - Ministère de l\'Équipement et de l\'Eau       ║');
  console.log('╚══════════════════════════════════════════════════════════════════════╝');
  console.log('');
  ...
  try {
    ...
    // Import 2024 data
    await importIndexes(OFFICIAL_DATA_2024);
...
export { importIndexes, generateReport, OFFICIAL_DATA_2024 };

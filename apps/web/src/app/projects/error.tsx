...
/**
 * Projects segment boundary. Even though ProjectsPage now degrades in-place (each fetch
 ...
 * atlas.marocinfra.com/projects).
 */
const STATUS_MESSAGES: Record<string, string> = {
  '403': "Votre rôle n'a pas accès aux projets.",
...
function explain(error: Error & { digest?: string }): string {
  ...
  return (
    ...
    'Impossible de charger les projets pour le moment. Les données sont intactes — réessayez.'
  );
}
...
export default function ProjectsError({
  ...
  return (
    <div className="mx-auto max-w-lg rounded-xl border border-clay-soft bg-clay-soft/20 p-8 text-center">
      <h1 className="text-lg font-bold text-clay">Projets momentanément indisponibles</h1>

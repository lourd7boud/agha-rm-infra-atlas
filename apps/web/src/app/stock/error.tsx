...
/**
 * Stock segment boundary. Even though StockPage now degrades in-place (each fetch
 ...
 * atlas.marocinfra.com/stock).
 */
const STATUS_MESSAGES: Record<string, string> = {
  '403': "Votre rôle n'a pas accès au stock.",
...
function explain(error: Error & { digest?: string }): string {
  ...
  return (
    ...
    'Impossible de charger le stock pour le moment. Les données sont intactes — réessayez.'
  );
}
...
export default function StockError({
  ...
  return (
    <div className="mx-auto max-w-lg rounded-xl border border-clay-soft bg-clay-soft/20 p-8 text-center">
      <h1 className="text-lg font-bold text-clay">Stock momentanément indisponible</h1>

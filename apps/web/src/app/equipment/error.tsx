...
/**
 * Equipment segment boundary. Even though EquipmentPage now degrades in-place (each fetch
 ...
 * atlas.marocinfra.com/equipment).
 */
const STATUS_MESSAGES: Record<string, string> = {
  '403': "Votre rôle n'a pas accès au matériel.",
...
function explain(error: Error & { digest?: string }): string {
  ...
  return (
    ...
    'Impossible de charger le matériel pour le moment. Les données sont intactes — réessayez.'
  );
}
...
export default function EquipmentError({
  ...
  return (
    <div className="mx-auto max-w-lg rounded-xl border border-clay-soft bg-clay-soft/20 p-8 text-center">
      <h1 className="text-lg font-bold text-clay">Matériel momentanément indisponible</h1>

...
/**
 * Vault segment boundary. Even though VaultPage now degrades in-place (each fetch
 ...
 * atlas.marocinfra.com/vault).
 */
const STATUS_MESSAGES: Record<string, string> = {
  '403': "Votre rôle n'a pas accès au coffre-fort.",
...
function explain(error: Error & { digest?: string }): string {
  ...
  return (
    ...
    'Impossible de charger le coffre-fort pour le moment. Les données sont intactes — réessayez.'
  );
}
...
export default function VaultError({
  ...
  return (
    <div className="mx-auto max-w-lg rounded-xl border border-clay-soft bg-clay-soft/20 p-8 text-center">
      <h1 className="text-lg font-bold text-clay">Coffre-fort momentanément indisponible</h1>

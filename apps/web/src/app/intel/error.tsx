...
/**
 * Intel segment boundary. Even though IntelPage now degrades in-place (each fetch
 ...
 * atlas.marocinfra.com/intel).
 */
const STATUS_MESSAGES: Record<string, string> = {
  '403': "Votre rôle n'a pas accès à l'intelligence marché.",
...
function explain(error: Error & { digest?: string }): string {
  ...
  return (
    ...
    "Impossible de charger l'intelligence marché pour le moment. Les données sont intactes — réessayez."
  );
}
...
export default function IntelError({
  ...
  return (
    <div className="mx-auto max-w-lg rounded-xl border border-clay-soft bg-clay-soft/20 p-8 text-center">
      <h1 className="text-lg font-bold text-clay">Intelligence marché momentanément indisponible</h1>

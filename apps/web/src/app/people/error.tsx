...
/**
 * People segment boundary. Even though PeoplePage now degrades in-place (each fetch
 ...
 * atlas.marocinfra.com/people).
 */
const STATUS_MESSAGES: Record<string, string> = {
  '403': "Votre rôle n'a pas accès au personnel.",
...
function explain(error: Error & { digest?: string }): string {
  ...
  return (
    ...
    'Impossible de charger le personnel pour le moment. Les données sont intactes — réessayez.'
  );
}
...
export default function PeopleError({
  ...
  return (
    <div className="mx-auto max-w-lg rounded-xl border border-clay-soft bg-clay-soft/20 p-8 text-center">
      <h1 className="text-lg font-bold text-clay">Ressources humaines momentanément indisponibles</h1>

...
/**
 * Supply segment boundary. Even though SupplyPage now degrades in-place (each fetch
 ...
 * atlas.marocinfra.com/supply).
 */
const STATUS_MESSAGES: Record<string, string> = {
  '403': "Votre rôle n'a pas accès aux approvisionnements.",
...
function explain(error: Error & { digest?: string }): string {
  ...
  return (
    ...
    'Impossible de charger les approvisionnements pour le moment. Les données sont intactes — réessayez.'
  );
}
...
export default function SupplyError({
  ...
  return (
    <div className="mx-auto max-w-lg rounded-xl border border-clay-soft bg-clay-soft/20 p-8 text-center">
      <h1 className="text-lg font-bold text-clay">Approvisionnements momentanément indisponibles</h1>

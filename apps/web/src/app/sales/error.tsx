...
/**
 * Sales segment boundary. Even though SalesPage now degrades in-place (each fetch
 ...
 * atlas.marocinfra.com/sales).
 */
const STATUS_MESSAGES: Record<string, string> = {
  '403': "Votre rôle n'a pas accès aux ventes.",
...
function explain(error: Error & { digest?: string }): string {
  ...
  return (
    ...
    'Impossible de charger les ventes pour le moment. Les données sont intactes — réessayez.'
  );
}
...
export default function SalesError({
  ...
  return (
    <div className="mx-auto max-w-lg rounded-xl border border-clay-soft bg-clay-soft/20 p-8 text-center">
      <h1 className="text-lg font-bold text-clay">Ventes momentanément indisponibles</h1>

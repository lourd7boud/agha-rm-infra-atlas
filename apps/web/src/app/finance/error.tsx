...
/**
 * Finance segment boundary. Even though FinancePage now degrades in-place (each fetch
 ...
 * atlas.marocinfra.com/finance).
 */
const STATUS_MESSAGES: Record<string, string> = {
  '403': "Votre rôle n'a pas accès à la finance.",
...
function explain(error: Error & { digest?: string }): string {
  ...
  return (
    ...
    'Impossible de charger la finance pour le moment. Les données sont intactes — réessayez.'
  );
}
...
export default function FinanceError({
  ...
  return (
    <div className="mx-auto max-w-lg rounded-xl border border-clay-soft bg-clay-soft/20 p-8 text-center">
      <h1 className="text-lg font-bold text-clay">Finance momentanément indisponible</h1>
